...
export default function DalaemfitSvg({ className }: IiconProps) {
    return (
        <svg className={`${className}`} width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            <path fillRule="evenodd" clipRule="evenodd" d="M18.5938 11.5C18.5938 12.4961 18.1083 13.3789 17.3611 13.9245L18.4413 14.1692C18.6672 14.2203 18.8571 14.3724 18.9564 14.5817L20.7839 18.4338C20.7957 18.4588 20.8064 18.484 20.8161 18.5094L23.8232 20.3681C24.293 20.6585 24.4384 21.2747 24.148 21.7445C23.8577 22.2143 23.2414 22.3597 22.7716 22.0694L19.3364 19.9461C19.2444 19.8892 19.1648 19.8198 19.0985 19.7414C18.9665 19.6401 18.8578 19.5042 18.7878 19.3394L18.5938 18.8828V20.8594C20.4052 21.7494 23.2484 23.6685 22.4582 25.4489C21.6134 27.3525 17.5299 26.2421 15.5938 25.4489C13.6577 26.2421 9.57429 27.3525 8.72944 25.4489C7.9393 23.6685 10.7825 21.7494 12.5938 20.8594V19.3227L12.5098 19.5206C12.4398 19.6855 12.3311 19.8213 12.1991 19.9226C12.1328 20.001 12.0532 20.0704 11.9611 20.1273L8.52591 22.2506C8.05612 22.5409 7.43989 22.3955 7.14951 21.9257C6.85914 21.4559 7.00458 20.8397 7.47437 20.5493L10.4815 18.6906C10.4911 18.6652 10.5018 18.64 10.5137 18.615L12.3412 14.7629C12.4404 14.5536 12.6303 14.4015 12.8562 14.3504L13.9813 14.0956C14.0048 14.088 14.0284 14.0809 14.0523 14.0742C13.1786 13.5498 12.5938 12.5932 12.5938 11.5C12.5938 9.84315 13.937 8.5 15.5938 8.5C17.2507 8.5 18.5938 9.84315 18.5938 11.5Z" className="fill-current" />
            <path d="M9.59375 12.9243L11.5482 12.5" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
            <path d="M9.61328 9.42627L11.5241 10.0168" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
            <path d="M11.5938 6.5L12.8545 7.78858" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
            <path d="M21.2881 12.5L19.3336 12.0757" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
            <path d="M21.5752 9.42627L19.6644 10.0168" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
            <path d="M19.5947 6.5L18.334 7.78858" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
            <path d="M15.5938 7L15.5937 5" className="stroke-current" strokeWidth="0.8" strokeLinecap="round" />
        </svg>
