...
export default function MyPageCard({
  ...
  return (
    <div className="relative flex h-[352px] w-[311px] max-w-[996px] flex-col justify-between xs:h-[180px] xs:w-full xs:flex-col">
      {/* 리뷰 작성 모달 */}
      {isModalOpen && (
      ...
      <div className="flex h-[328px] w-full flex-col justify-between xs:h-[156px] xs:w-[545px] xs:flex-row">
        {/* 모임 이미지 */}
        <div className="relative flex size-full items-center justify-center overflow-hidden rounded-3xl border border-dashed xs:w-[280px]">
